...
const badCode = `                  const isResolving = isLoadingEpisodes || !orchestratedMedia || playbackHealth === 'resolving' || playbackHealth === 'idle';
...
if (!watch.includes("Initializing Stream Engine...")) {
